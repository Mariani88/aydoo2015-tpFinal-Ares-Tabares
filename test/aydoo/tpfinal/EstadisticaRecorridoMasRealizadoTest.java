...
public class EstadisticaRecorridoMasRealizadoTest {
	...
	public void generarEstadisticaParaRecorridoMasRealizadoDebeDevolverUnPar6Coma5(){
		...
		Assert.assertEquals("6;5", recorridoMasRealizado.generarEstadistica(listaDeRecorridos));
	...
	public void cuandoGeneroUnaEstadisticaConUnaListaVaciaDebeLanzaeUnaExcepcionYDevolverNull(){
		...
		Assert.assertEquals(null, recorridoMasRealizado.generarEstadistica(listaDeRecorridos));
